...
[Short description of the project, e.g., A state-tracking application built without using OOP classes.]

* **Concepts solidified:** Lexical scoping, Closures, and maintaining internal state using functional programming principles.
